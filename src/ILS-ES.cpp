...
void ILS_ES::mutacion(tSolution &solucion_inicial, tSolution &no_seleccionados ,const int SIZE_MUTATION){
...
ResultMH ILS_ES::optimize(Problem *problem, int maxevals){
    ...
    ResultMH result = enfriamiento_simulado.optimize(realproblem, solucion_inicial, fitness_inicial, EVALS_ES);
